...
// closureEntry holds the compiled SwiGLU closures for a single Qwen2 instance.
...
func closureKey(q *Qwen2) uintptr {
...
// fallback.
func (q *Qwen2) swigluClosure(layerIdx int) any {
	closureMu.Lock()
...
func (q *Qwen2) applySwigluClosure(c any, h tensor.Array) (tensor.Array, error) {
...
// freeSwigluClosures releases all compiled closures for a Qwen2 instance.
// Called from FreeWeights to prevent leaked MLX closures.
func freeSwigluClosures(q *Qwen2) {
	closureMu.Lock()
