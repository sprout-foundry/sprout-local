...
func (q *Qwen2) attention(h tensor.Array, lw *layerWeights, layerIdx, seqLen, startPos int, cache *llm.KVCache) (tensor.Array, error) {
	s := q.stream
	cfg := q.cfg
...
func (q *Qwen2) swiglu(h tensor.Array, lw *layerWeights, layerIdx int) (tensor.Array, error) {
	if useCompiledFFN() {
